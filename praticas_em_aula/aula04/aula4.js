...
pets.forEach(
  ...
  function(umPet, index) {
  
    console.log(index + " - " + umPet.nome);
    console.log(index + " - " + umPet.tipo);
...
let dataDoServiço = new Date()
let dataFinal = dataDoServiço.getDate() + "/" + 
(dataDoServiço.getMonth() + 1) + "/" + dataDoServiço.getFullYear();

console.log(dataDoServiço);
...
const darBanhoNoPet = (pet) => {
  ...
  pet.servicos.push("serviço de banho realizado em " + dataFinal )
  console.log("O pet " + pet.nome + " tomou banho no dia " + dataFinal);
}

const tosarPet = (pet) => {
  // pet.servicos.push("tosa")
  pet.servicos.push("serviço de tosa realizado em " + dataFinal)
  console.log("O pet " + pet.nome + " foi tosado no dia " + dataFinal);
}
...
const filtrarPetPorNome = (array, nomePets) => {
    let petsFiltrados =  pets.filter((pet) => {
    return pet.nome == nomePets
  })
};


console.log(filtrarPetPorNome('Yoshi'));